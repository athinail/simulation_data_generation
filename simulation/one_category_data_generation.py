...
def main():
    sets = ["test"]
    class_categories = [1] # 0 - circle (gravity), 1 - sqare (mass,sprinf,damping)
            ...
            for init_vel in random_velocities:
                for center_z in random_center_z_range:
                    ...
                    for class_category in class_categories:
                        ...
                        videofile_directory_name = os.path.join(data_directory, "Annotations", "test_more_rounded_cornerns_square", file)
